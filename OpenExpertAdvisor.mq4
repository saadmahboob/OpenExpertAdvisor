//+------------------------------------------------------------------+
//|                                            OpenExpertAdvisor.mq4 |
//|                             Copyright 2016-2017, Maxime Labelle. |
//+------------------------------------------------------------------+
#property copyright "Copyright 2016-2017, Maxime Labelle."
#property link      "https://github.com/maxlabelle/OpenExpertAdvisor"
#property version   "1.00"
#property strict

/*

input string XXXXXXX23 = "Timeframes M15 : USDCHF/17sprd (ATR SL : 4), EURCHF/18sprd (20:00 to 1:00), AUDCAD/20sprd (CCI BUY 350), AUDCHF/22sprd (20:00 to 1:00, CCI BUY 275), CADCHF/23sprd (CCI SELL: 225 CCI BUY 350), CHFJPY/23sprd (CCI BUY 350), GBPCHF/38sprd"; // ---
...
input string XXXXXXX2 = "Open Expert Advisor v1.0 "; // ---
...
double ATR_TP_Multiplicator = 2; // ATR Take Profit multiplicator
...
void OnTick() {
   ...
   if (Period() != 5) {
      Print("OpenExpertAdvisor will only run when attached to the 5min chart");
      return;
   }
   ...
   if (SelectedSymbol == 1) {
      ...
      STRATEGY_CCI_THRESHOLD_SELL = 250;
...
void Sell() {
   ...
   int Sell = OrderSend(Symbol(),OP_SELL,Lot,OpenPrice,Slippage,Loss,0,"OpenExpertAdvisor",Magic,0,clrRed);
...
void Buy() {
   ...
   double Loss = OpenPrice-(StopLoss*Point());
   int Buy = OrderSend(Symbol(),OP_BUY,Lot,OpenPrice,Slippage,Loss,0,"OpenExpertAdvisor",Magic,0,clrAliceBlue);
...
EURCHF:
dyn atr: 91.20% 7357$ 216x
fixed atr: 89.25% 6364$ 214x

USDCHF:
dyn atr: 92.11% 4115$ 76x
fixed atr: 91.14% 4053$ 79x
...
void CreateInfoBox() {
   ...
   WriteText("Open", 45, 90, 16, C'64,64,64', "Arial Black");
   WriteText("EA", 80, 120, 16, C'64,64,64', "Arial Black");
